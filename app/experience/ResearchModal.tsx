...
export default function ResearchModal({ items }: { items: ResearchProofItem[] }) {
  ...
  const view = params.get("research");
  ...
  const proofKey = params.get("proof");
  const legacyDoc = (params.get("doc") as "pdf" | "ppt" | null) ?? null;
            ...
            {hasDoc ? (
                ...
                <div className="flex h-full w-full flex-col items-center justify-center p-8 text-center">
                  <div className="max-w-md">
                    ...
                    <p className="mt-2 text-sm text-white/70">
                      This proof file can’t be previewed here. Use Open/Download to view it.
                    </p>
                    <div className="mt-4 flex items-center justify-center gap-2">
                      <a
                        href={src as string}
              ...
              <div className="flex h-full w-full items-center justify-center p-8 text-center">
                <div>
                  ...
                  <p className="mt-2 text-sm text-white/70">Add a PDF/PPT path for this research entry.</p>
                </div>
              </div>
            )}
          </div>
